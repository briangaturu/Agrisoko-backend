ALTER TABLE "conversation_participants" ALTER COLUMN "id" SET DATA TYPE uuid;--> statement-breakpoint
ALTER TABLE "conversation_participants" ALTER COLUMN "id" SET DEFAULT gen_random_uuid();--> statement-breakpoint
ALTER TABLE "conversation_participants" ALTER COLUMN "conversation_id" SET DATA TYPE uuid;--> statement-breakpoint
...
ALTER TABLE "crop_prices" ALTER COLUMN "id" SET DATA TYPE uuid;--> statement-breakpoint
ALTER TABLE "crop_prices" ALTER COLUMN "id" SET DEFAULT gen_random_uuid();--> statement-breakpoint
ALTER TABLE "crop_prices" ALTER COLUMN "crop_id" SET DATA TYPE uuid;--> statement-breakpoint
ALTER TABLE "crops" ALTER COLUMN "id" SET DATA TYPE uuid;--> statement-breakpoint
ALTER TABLE "crops" ALTER COLUMN "id" SET DEFAULT gen_random_uuid();--> statement-breakpoint
ALTER TABLE "listing_images" ALTER COLUMN "id" SET DATA TYPE uuid;--> statement-breakpoint
ALTER TABLE "listing_images" ALTER COLUMN "id" SET DEFAULT gen_random_uuid();--> statement-breakpoint
ALTER TABLE "listing_images" ALTER COLUMN "listing_id" SET DATA TYPE uuid;--> statement-breakpoint
...
ALTER TABLE "listings" ALTER COLUMN "farmer_id" SET DATA TYPE uuid;--> statement-breakpoint
ALTER TABLE "listings" ALTER COLUMN "crop_id" SET DATA TYPE uuid;--> statement-breakpoint
...
ALTER TABLE "order_items" ALTER COLUMN "listing_id" SET DATA TYPE uuid;--> statement-breakpoint
